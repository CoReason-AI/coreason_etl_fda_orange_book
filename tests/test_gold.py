...
class TestGoldLogic:
    ...
    def test_create_gold_view_basic(self, silver_products, silver_patents, silver_exclusivity):
    ...
    def test_create_gold_view_include_discontinued(self, silver_products, silver_patents, silver_exclusivity):
    ...
    def test_missing_patents_exclusivity(self, silver_products):
